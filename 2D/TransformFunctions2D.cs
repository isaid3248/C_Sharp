...
public class TransformFunctions2D : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKey(KeyCode.UpArrow))
            transform.Translate(Vector2.forward * moveSpeed * Time.deltaTime);
        ...
        if (Input.GetKey(KeyCode.Space))
            transform.Translate(Vector2.up * playerJumpHeight * Time.deltaTime);

        if (Input.GetKey(KeyCode.LeftShift))
            transform.Translate(-Vector3.up * playerJumpHeight * Time.deltaTime);

        if (Input.GetKey(KeyCode.RightShift))
            transform.Translate(Vector2.forward * slowSpeed * Time.deltaTime);
